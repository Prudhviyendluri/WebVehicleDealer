	...
	function validate()
{
	...
	if(isNaN(document.payment.paid_amount.value))
	{
		alert("Invalid amount..");
		document.payment.paid_amount.value = "";
		document.payment.paid_amount.focus();
		return false;
	}
...
<table width="653" border="1"  class="tftable">
  <tr>
    <td colspan="2" scope="row" align="center"><strong>Make payment</strong></td>
  </tr>
  <tr>
    <td width="183" scope="row">Payable amount</td>
    <td width="454"><label for="sellingprice2"></label>
      ...
      <input name="sellingprice2" type="text" id="sellingprice2" size="20" value="<?php //Developed by Freelance developer. If you finding any trouble please visit http://www.freestudentprojects.com/phpscript/web-vehicle-agent-system/ for support page. echo $rsvehrec[vehicle_cost]; ?>" />
      <input type="submit" name="submit" id="submit" value="Change" /></td>
  </tr>
<?php //Developed by Freelance developer. If you finding any trouble please visit http://www.freestudentprojects.com/phpscript/web-vehicle-agent-system/ for support page.
$paidamt = 0;
...
?>  
  <tr>
    <td scope="row">Previously Paid Amount</td>
    <td><input name="paidamount2" type="text" id="paidamount2" value="<?php //Developed by Freelance developer. If you finding any trouble please visit http://www.freestudentprojects.com/phpscript/web-vehicle-agent-system/ for support page. echo $paidamt; ?>" readonly="readonly" /></td>
  </tr>
  <tr>
    <td scope="row">Currently Paid Amount</td>
    <td><input name="paid_amount" type="text" id="paid_amount" value="" onkeyup="calc()" /></td>
  </tr>
  <tr>
    <td scope="row">Remaining Balance</td>
    <td><input name="balance" type="text" id="balance" value="<?php //Developed by Freelance developer. If you finding any trouble please visit http://www.freestudentprojects.com/phpscript/web-vehicle-agent-system/ for support page. echo $rembalance = $rsvehrec[vehicle_cost] - $paidamt; ?>" /></td>
  </tr>
  <tr>
    <td scope="row">Payment type</td>
    <td><select name="payment_type" id="payment_type">
      <?php //Developed by Freelance developer. If you finding any trouble please visit http://www.freestudentprojects.com/phpscript/web-vehicle-agent-system/ for support page.
				$arr = array("Select","Cash","Cheque");
  ...
  <tr>
    <td width="183" scope="row">Date</td>
    <td width="454"><label for="sellingprice2"></label>
      <input name="paiddate" type="date" id="paiddate" size="20" value="" /></td>
  </tr>


  <tr>
    <td colspan="2" scope="row" align="center"><input type="submit" name="btnpayment" id="btnpayment" value="Submit" /></td>
  </tr>
</table>
<hr />
