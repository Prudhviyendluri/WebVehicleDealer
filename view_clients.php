...
<?php //Developed by Freelance developer. If you finding any trouble please visit http://www.freestudentprojects.com/phpscript/web-vehicle-agent-system/ for support page.
 while($rs = mysqli_fetch_array($qresult))
 {
	...
	<td>";
	if(!isset($_GET[selveh]))
	{
	echo "&nbsp; <a href='clients.php?editid=$rs[client_id]'>Edit</a> <br><br>
	&nbsp; <a href='view_clients.php?delid=$rs[client_id]'>Delete</a> </td>";
	}
	else
	{
	echo "&nbsp; <a href='vehicles.php?selid=$rs[client_id]'>Select</a> <br><br>";
	}
  	echo "</tr>";
 }
 ?>
