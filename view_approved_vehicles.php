...
{
$qresult = mysqli_query($con,"SELECT     vehicle.*, vehicle_company.*, clients.* FROM vehicle LEFT OUTER JOIN vehicle_company ON vehicle.company_id = vehicle_company.company_id LEFT OUTER JOIN clients ON vehicle.client_id = clients.client_id where vehicle.status = 'Approved' ");
}
else
{
$qresult = mysqli_query($con,"SELECT     vehicle.*, vehicle_company.*, clients.* FROM vehicle LEFT OUTER JOIN vehicle_company ON vehicle.company_id = vehicle_company.company_id LEFT OUTER JOIN clients ON vehicle.client_id = clients.client_id where vehicle.status = 'Approved' ");
