...
<table width="653" border="1"  class="tftable">
  ...
  <tr>
    <td width="183" scope="row"><strong>Selling price</strong></td>
  ...
  <tr>
    ...
    <td><?php //Developed by Freelance developer. If you finding any trouble please visit http://www.freestudentprojects.com/phpscript/web-vehicle-agent-system/ for support page. echo $rsvehrec[comments]; ?></td>
  </tr>
  <tr>
    <td scope="row"><strong>Status</strong></td>
    <td><?php //Developed by Freelance developer. If you finding any trouble please visit http://www.freestudentprojects.com/phpscript/web-vehicle-agent-system/ for support page. echo $rsvehrec[status] ;
			?>
      </select></td>
  </tr>
  <tr>
    <td colspan="2" scope="row" align="center"><a href='clients_vehicles_payment.php?order_id=<?php //Developed by Freelance developer. If you finding any trouble please visit http://www.freestudentprojects.com/phpscript/web-vehicle-agent-system/ for support page. echo $_GET[order_id]; ?>'><strong>View  payment details</strong></a></td>
  </tr>
  </table>
